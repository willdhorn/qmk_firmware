...
#define COLEMAX_1 DEF_TOP(COLEMAX_L1, COLEMAX_R1)
#define COLEMAX_2 DEF_MID(COLEMAX_L2, COLEMAX_R2)
#define COLEMAX_3 DEF_BOT(COLEMAX_L3, COLEMAX_R3)
#define COLEMAX_4 DEFAULT_BASE

#define LAYER_COLEMAX PLANCK_LAYOUT(COLEMAX_1, COLEMAX_2, COLEMAX_3, COLEMAX_4)
...
#define NUM_4 KC_EMPTY, KC_EMPTY, KC_EMPTY, STD_LK_LEFT, STD_LK_LOWR, TO(0), KC_0, KC_DOT, KC_EMPTY, KC_EMPTY, KC_EMPTY
