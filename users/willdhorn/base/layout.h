...
#define X_SIDE _x_, _x_, _x_, _x_, _x_

#define MODS_L OSM(MOD_LCTL), OSM(MOD_LALT), OSM(MOD_LSFT), OSM(MOD_LGUI)
#define MODS_R OSM(MOD_RGUI), OSM(MOD_RSFT), OSM(MOD_RALT), OSM(MOD_RCTL)

#define CMDS_L S_UNDO, S_CUT, S_COPY, TH(thPaste)
#define CMDS_R TH(thPaste), S_COPY, S_CUT, S_UNDO
